(function(){
    ...
    goog.events.listen(window, 'load', function() {
        ...
        document.getElementById("download").addEventListener("click", (function() {snapshotPopup.recordDownload(chrome.extension.getBackgroundPage().snapshot.changeLogRevision)}), false);
